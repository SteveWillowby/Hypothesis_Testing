...
def visualize_my_universal_bound_on_binomial(num_flips, coin_prob=0.5, marked_points=[], num_priors=1001):
    ...
    marked_points = [(a, b, my_universal_bound_on_binomial(num_flips, a, coin_prob, b) \
    ...
    ax.scatter(marked_x, marked_y, marked_z, 'green')
